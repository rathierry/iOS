...
class VirtualObjectManager {
    ...
    func loadNillousObject(_ object: VirtualObject, to position: SCNVector3, index: Int) {
        self.virtualObjects.append(object)
        self.delegate?.virtualObjectManager(self, willLoad: object)
	...
	private func setNewVirtualObjectPosition(_ object: VirtualObject, to pos: float3, cameraTransform: matrix_float4x4) {
        ...
        print("\ncameraToPosition: ", cameraToPosition, " - ", type(of: cameraToPosition), " - simd_length(cameraToPosition): ", simd_length(cameraToPosition))
