...
class Figure {
    ...
    class func xFigure() -> SCNNode {
        ...
        geometry.firstMaterial?.diffuse.contents = UIImage(named: "Models.scnassets/tictactoe/scuffed-plastic6-alb.png")
        geometry.firstMaterial?.roughness.contents = UIImage(named: "Models.scnassets/tictactoe/scuffed-plastic-rough.png")
        geometry.firstMaterial?.metalness.contents = UIImage(named: "Models.scnassets/tictactoe/scuffed-plastic-metal.png")
        geometry.firstMaterial?.normal.contents = UIImage(named: "Models.scnassets/tictactoe/scuffed-plastic-normal.png")
        geometry.firstMaterial?.ambientOcclusion.contents = UIImage(named: "Models.scnassets/tictactoe/scuffed-plastic-ao.png")
    ...
    class func oFigure() -> SCNNode {
        ...
        geometry.firstMaterial?.lightingModel = .physicallyBased
        geometry.firstMaterial?.diffuse.contents = UIImage(named: "Models.scnassets/tictactoe/scuffed-plastic4-alb.png")
        geometry.firstMaterial?.roughness.contents = UIImage(named: "Models.scnassets/tictactoe/scuffed-plastic-rough.png")
        geometry.firstMaterial?.metalness.contents = UIImage(named: "Models.scnassets/tictactoe/scuffed-plastic-metal.png")
        geometry.firstMaterial?.normal.contents = UIImage(named: "Models.scnassets/tictactoe/scuffed-plastic-normal.png")
        geometry.firstMaterial?.ambientOcclusion.contents = UIImage(named: "Models.scnassets/tictactoe/scuffed-plastic-ao.png")
