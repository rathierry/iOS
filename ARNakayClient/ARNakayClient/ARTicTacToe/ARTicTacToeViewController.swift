//
//  ARTicTacToeViewController.swift
//  ARNakayClient
//
//  Created by NelliStudio on 30/11/2017.
...
class ARTicTacToeViewController: BaseViewController, ARSCNViewDelegate {
    ...
    func enableEnvironmentMapWithIntensity(_ intensity: CGFloat) {
        if sceneView.scene.lightingEnvironment.contents == nil {
            if let environmentMap = UIImage(named: "Models.scnassets/tictactoe/environment_blur.exr") {
