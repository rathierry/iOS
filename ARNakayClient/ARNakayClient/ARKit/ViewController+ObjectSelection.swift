...
extension ARKitViewController: VirtualObjectSelectionViewControllerDelegate, VirtualObjectManagerDelegate {
    ...
    func virtualObjectSelectionViewController(_: VirtualObjectSelectionViewController, didSelectObjectAt index: Int) {
        ...
        print("\n--- ViewController+ObjectSelection | virtualObjectSelectionViewController ---\n")
        print("position: ", position, " - typeOF: ", type(of: position), " - position.x: ", position.x, " - position.y: ", position.y, " - position.z: ",position.z, "\n")
        ...
        print("parameters: ", parameters, " - typeOF: ", type(of: parameters), "\n")

        // urlPath
        let urlPath = scriptUrl + "/api/postNewNillous"
    ...
    func placingAllNillous(array: Array<Any>) -> Void {
        ...
        for i in 0...self.nillousesCount-1 {
            ...
            print("\n--- ViewController+ObjectSelection | placingAllNillous ---\n")
            print("position: ", position, " - index: ", index, " - object: ", object, " - cameraTransform: ", cameraTransform, "\n")
