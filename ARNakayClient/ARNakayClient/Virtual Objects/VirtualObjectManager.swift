...
class VirtualObjectManager {
	...
	// MARK: - Loading object
    func loadVirtualObject(_ object: VirtualObject, to position: float3, cameraTransform: matrix_float4x4, index: Int) {
        ...
        DispatchQueue.global(qos: .userInitiated).async {
            ...
            print("\n--- VirtualObjectManager | loadVirtualObject ---\n")
            print("1) indexObject: ", index, "\n2) position:\n - x = ", position.x, "\n - y = ", position.y, "\n - z = ", position.z, "\n3) cameraTransform: ", cameraTransform, "\n")
            
            if index == 0 || index == 2 || index == 5 {
                object.simdLook(at: position)
            }
...
//        baseVC.showAlertMessage(title: "TITRE", message: "MESSAGE")
	...
	private func setNewVirtualObjectPosition(_ object: VirtualObject, to pos: float3, cameraTransform: matrix_float4x4) {
        ...
        print("\n--- VirtualObjectManager | setNewVirtualObjectPosition ---\n")
        print("cameraToPosition: ", cameraToPosition, " - typeOF: ", type(of: cameraToPosition), " - simd_length(cameraToPosition): ", simd_length(cameraToPosition), "\n")
        print("Object detected : ", object.definition.displayName, "\n")
