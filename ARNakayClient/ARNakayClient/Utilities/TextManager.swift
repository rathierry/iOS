...
class TextManager {
    ...
    private var viewController: ARKitViewController!
	...
	init(viewController: ARKitViewController) {
    ...
    func showAlertCustomize(title: String, message: String, actions: [UIAlertAction]? = nil) {
        // alert
